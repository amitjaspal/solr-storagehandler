...
/*
 * SolrSerDe is used to serialize and deserialize the data for writing
 * and reading to SOLR respectively. SolrRecordReader returns data in
 * MapWritable Format which is then deserialized into Hive complaint
 * format using the deserialize method. Similarly Hive complaint data
 * is serialized into MapWritable Format using the serialize method
 */
public class SolrSerDe extends AbstractSerDe {

  private static final Logger LOG = Logger.getLogger(SolrSerDe.class.getName());
