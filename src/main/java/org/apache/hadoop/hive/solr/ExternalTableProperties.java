...
public class ExternalTableProperties {
  ...
  private static final Logger LOG = Logger.getLogger(ExternalTableProperties.class);
  public static final String ZOOKEEPER_SERVICE_URL = "solr.zookeeper.service.url";
